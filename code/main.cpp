...
// Entry point for the Finite Galaxy executable.
...
void GameLoop(PlayerInfo &player, Conversation &conversation, bool &debugMode)
{
  ...
  // All other game content related dialogues are placed on top of the gamePanels.
...
void PrintHelp()
{
  ...
  cerr << endl;
  cerr << "Report bugs to: <https://github.com/finite-galaxy/finite-galaxy/issues>" << endl;
  cerr << endl;
}
