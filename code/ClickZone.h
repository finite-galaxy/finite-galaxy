...
public:
  ...
  ClickZone(Point centre, Point dimensions, Type value = 0);
...
template <class Type>
ClickZone<Type>::ClickZone(Point centre, Point dimensions, Type value)
  : Rectangle(centre, dimensions), value(value)
{
}
