...
// This class represents a set of constraints on a randomly chosen system, planet,
// or ship. For example, it can require that the planet used for a mission have
