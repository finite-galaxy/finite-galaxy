...
Both games can be installed alongside and played independently of each other. Although it is possible to copy a save game from Endless Sky to Finite Galaxy or vice versa, there will be minor errors, because both games are diverging, therefore starting a new pilot storyline is recommended.
